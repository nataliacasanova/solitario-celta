...
public class SCeltaViewModel extends AndroidViewModel {
    ...
    static public final int TAMANIO = JuegoCelta.TAMANIO;
    static public final int HUECO = JuegoCelta.HUECO;
    static public final int FICHA = JuegoCelta.FICHA;

    private JuegoCelta _juego;

    public SCeltaViewModel(@NonNull Application application) {
        super(application);
